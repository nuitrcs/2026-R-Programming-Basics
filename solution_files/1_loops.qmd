...
countries = unique(medals$noc)

for (country in countries) {
  country_data = medals %>%
    filter(noc == country)
  
  write.csv(country_data, paste0("data/", country, ".csv"))
}
```
